  ...
  return (
    <div className="flex flex-col items-center justify-center py-8 gap-6">
      ...
      <div style={{ perspective: "1600px" }}>
        <div
          className="relative"
          style={{ width: `${w}px`, height: `${h}px`, transformStyle: "preserve-3d" }}
        >
          {/* ==== STATIC BACK PAGE (last page back or placeholder) ==== */}
          <div
            className="absolute inset-0"
            style={{ zIndex: 0, boxShadow: isOpen ? "0 4px 20px rgba(0,0,0,0.3)" : "none", transition: "box-shadow 0.5s" }}
          >
            ...
            return (
              <motion.div
                ...
                style={{
                  ...
                  zIndex: totalPages - pageIdx + 1, // page 0 on top
                }}
                initial={false}
