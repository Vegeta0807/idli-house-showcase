  ...
  <section id="about" className="py-28 md:py-40 bg-card relative overflow-hidden">
    ...
    <div className="container mx-auto px-6 md:px-12 relative">
      <div className="max-w-3xl mx-auto text-center mb-20">
        <SmoothReveal>
          <p className="text-accent font-body font-bold text-xs uppercase tracking-[0.3em] mb-4">Our Story</p>
        </SmoothReveal>

        <TextReveal
          as="h2"
          className="font-display text-4xl md:text-6xl font-black text-foreground mb-8 leading-[1.05]"
        >
        ...
        {highlights.map((item) => (
          <StaggerItem key={item.label}>
            <TiltCard className="group h-full">
              <div className="flex flex-col items-center text-center p-8 md:p-10 rounded-3xl bg-background border border-border/50 hover:border-accent/40 transition-all duration-300 h-full shadow-sm hover:shadow-xl">
